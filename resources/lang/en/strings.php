...
return [
    ...
    */
    ...
    'backend' => [
        'access' => [
            'users' => [
                'delete_user_confirm'  => 'Are you sure you want to delete this user permanently? Anywhere in the application that references this users id will most likely error. Proceed at your own risk. This can not be un-done.',

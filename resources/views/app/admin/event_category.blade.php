...
$(".confirm").click(function () {
    $(".cancel").click()
    location.href = 'settings_event_category?id='+$id;   
})
...
$(".edit").click(function () {
    ...
    location.href = 'settings_event_category/create?id='+$id;   
})
</script>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ trans('menus.backend.access.settings_event_category.all') }}</h4>
                ...
                <div class="card-body collapse in">
                    <div class="card-block card-dashboard table-responsive">                      
                        <table id="example" class="table table-condensed compact table-hover">
                            <thead>
                                <tr>
                                    <th>{{ trans('labels.backend.access.settings_event_category.table.name') }}</th>
                                    <th>{{ trans('labels.backend.access.settings_event_category.table.code') }}</th>
                                    <th>{{ trans('labels.backend.access.settings_event_category.table.custom') }}</th>

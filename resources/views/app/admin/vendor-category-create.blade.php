...
@section('page-header')
    <h2 class="content-header-title">{{ trans('menus.backend.access.settings_vendor_category.management') }}</h2>
@endsection
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        @if($data==null){{ trans('menus.backend.access.settings_vendor_category.create') }}@endif
                        @if(!$data==null){{ trans('menus.backend.access.settings_vendor_category.edit') }}@endif
                    </h4>
                    <div class="heading-elements">
                        @include('partials.admin.vendor-category-header-buttons')
                    </div>
                </div>
                <div class="card-body collapse in">
                    ...
                    {{ Form::open(['route' => 'admin.access.settings_vendor_category.store', 'class' => 'form', 'role' => 'form', 'method' => 'post', 'id' => 'js-org-create-main']) }}
                        ...
                        <div class="col-xl-8 offset-xl-2">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Code Number" name="codeNumber" type="text" id="codeNumber" value="@if(!$data==null){{$data[0]->num_code}}@endif">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 offset-xl-2">
                            <div class="form-actions">
                                ...
                                <div class="pull-left">
                                    {{ link_to_route('admin.access.settings_vendor_category.index', 'Cancel', [], ['class' => 'btn btn-danger btn-xs']) }}
                                </div>

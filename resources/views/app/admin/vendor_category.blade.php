...
$(".confirm").click(function () {
    $(".cancel").click()
    location.href = 'settings_vendor_category?id='+$id;   
})
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ trans('menus.backend.access.settings_vendor_category.all') }}</h4>
                ...
                <div class="card-body collapse in">
                    <div class="card-block card-dashboard table-responsive">                      
                        <table id="example" class="table table-condensed compact table-hover">
                            <thead>
                                <tr>
                                    <th>{{ trans('labels.backend.access.settings_vendor_category.table.name') }}</th>
                                    <th>{{ trans('labels.backend.access.settings_vendor_category.table.code') }}</th>
                                    <th>{{ trans('labels.backend.access.settings_vendor_category.table.num_cod') }}</th>

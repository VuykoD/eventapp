...
@section('page-header')
    <h2 class="content-header-title">Vendor Management</h2>
@endsection
    ...
    $(function() {
        $('#users-table').DataTable({
            ...
            ajax: {
                ...
                url: '{{ route("admin.access.vendor.get") }}',
                type: 'post',
                data: {trashed: false, role: 'Vendor User'}
            },
            columns: [
                ...
                {data: 'status', name: '{{config('access.roles_table')}}.status', sortable: false},

...
{{ Form::open(['route' => ['frontend.avatar.upload', access()->user()->id], 'class' => 'form', 'role' => 'form', 'method' => 'post', 'id' => 'js-upload-avatar']) }}
...
<div class="row">
    <div class="form-group">
        <div class="col-md-2">
            <button type="button" id="js-button-upload" class="btn btn-primary">Upload Profile Image</button>
        </div>
    </div>
</div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <label class="modal-title text-text-bold-600">Crop Your Avatar</label>
                </div>

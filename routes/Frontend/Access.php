...
Route::group(['namespace' => 'Auth', 'as' => 'auth.'], function () {
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        Route::get('/vendor/signup', 'RegisterController@showRegistrationForm')->name('vendor.signup');
        Route::post('/vendor/signup', 'RegisterController@registerVendor')->name('vendor.signup.register');
        Route::post('/vendor/checkcode', 'RegisterController@checkOrgCode')->name('vendor.signup.checkcode');
    });
});
